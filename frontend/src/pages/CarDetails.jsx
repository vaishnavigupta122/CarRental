                ...
                [
                  {
                    ...
                    text: `${car.seatinf_capacity} Seats `
                  },
                  {
        ...
        <motion.form
          ...
          <div className='flex flex-col gap-2'>
            ...
            <input onChange={(e) => setPickupDate(e.target.value)}
              value={pickupDate}
              type='date' className='border border-gray-300 px-3 py-2 rounded-lg '
          ...
          <div className='flex flex-col gap-2'>
            ...
            <input onChange={(e) => setReturnDate(e.target.value)}
              value={returnDate}
              type='date' className='border borderColor px-3 py-2 rounded-lg '
              required id="return-date" min={pickupDate || new Date().toISOString().split('T')[0]} />
          </div>
