    ...
    return (
        <motion.div
            ...
            <motion.h1
                ...
                class="md:text-4xl text-2xl font-semibold">Never Miss a Deal!
            </motion.h1>
            ...
            <motion.form
                ...
                <input
                    ...
                    required
                />
                <button type="submit" class="md:px-12 px-8 h-full text-white bg-primary hover:primary-dull transition-all cursor-pointer rounded-md rounded-l-none">
                    Subscribe
                </button>
            </motion.form>
        </motion.div>
